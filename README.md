...
* [`src/amigoing/`](src/amigoing/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/amigoing/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `amigoing` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/amigoing/config.cljs) defaults to `true` in
...
```clj
(ns amigoing.example
  (:require [amigoing.config :as config])
